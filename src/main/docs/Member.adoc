...
.memberInfoReq 구성
include::{snippets}/member/add-info-fail-blank-info/request-fields.adoc[]
...
.request header
include::{snippets}/member/check-duplicated-nickname-success/request-headers.adoc[]

.memberModifyReq 구성
include::{snippets}/member/check-duplicated-nickname-success/request-fields.adoc[]
...
.request header
include::{snippets}/member/check-duplicated-nickname-fail/request-headers.adoc[]

.memberModifyReq 구성
include::{snippets}/member/check-duplicated-nickname-fail/request-fields.adoc[]
